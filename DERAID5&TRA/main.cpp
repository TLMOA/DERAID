...
//    cout<<"*****************************************"<<endl;
    ...
    auto start00 = chrono::high_resolution_clock::now(); // 开始时间

    RAID5M1(5,keyStream);

    auto end00 = chrono::high_resolution_clock::now(); // 结束时间

    chrono::duration<double, milli> elapsed00 = end00 - start00; // 计算经过的时间




    auto start11 = chrono::high_resolution_clock::now(); // 开始时间

    MRAID51(5,keyStream);

    auto end11 = chrono::high_resolution_clock::now(); // 结束时间

    chrono::duration<double, milli> elapsed11 = end11 - start11; // 计算经过的时间
    ...
    cout<<"更新过程******************************************"<<endl;
    auto start000 = chrono::high_resolution_clock::now(); // 开始时间

    RAID5M2(5,2,222,keyStream);

    auto end000 = chrono::high_resolution_clock::now(); // 结束时间

    chrono::duration<double, milli> elapsed000 = end000 - start000; // 计算经过的时间

    cout << "RAID5M2 " << elapsed000.count() << " milliseconds." << endl;



    auto start111 = chrono::high_resolution_clock::now(); // 开始时间

    MRAID52(5,2,222,keyStream);

    auto end111 = chrono::high_resolution_clock::now(); // 结束时间

    chrono::duration<double, milli> elapsed111 = end111 - start111; // 计算经过的时间
...
//    DERAID61(8);
    ...
    cout<<"重建过程******************************************"<<endl;
    auto start0000 = chrono::high_resolution_clock::now(); // 开始时间

    RAID5M3(5,1,keyStream);

    auto end0000 = chrono::high_resolution_clock::now(); // 结束时间

    chrono::duration<double, milli> elapsed0000 = end0000 - start0000; // 计算经过的时间

    cout << "RAID5M3 " << elapsed0000.count() << " milliseconds." << endl;



    auto start1111 = chrono::high_resolution_clock::now(); // 开始时间

    MRAID53(5,1,keyStream);

    auto end1111 = chrono::high_resolution_clock::now(); // 结束时间

    chrono::duration<double, milli> elapsed1111 = end1111 - start1111; // 计算经过的时间
